    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="view_userfile.php" class="list-group-item list-group-item-action waves-effect">
          ...
          <i class="fas fa-chalkboard-teacher"></i> User déconnecté</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-4">
         ...
         <div class="md-form mb-4">
          <i class="fas fa-user prefix grey-text"></i>
          <input type="text" id="orangeForm-pass" name="user_status" value = "Etudiant" class="form-control validate" readonly="">
          <label data-error="wrong" data-success="right" for="orangeForm-pass">User Status</label>
        </div>
      </div>
      <div class="modal-footer d-flex justify-content-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
                    ...
                    ?>
                <CENTER><h3 class="page-header" >Nombre de fichier telecharger par un étudiant   </h3></CENTER>  
