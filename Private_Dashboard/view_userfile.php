...
<head>
  ...
  <title>Gestons des memoires</title>
          ...
          <ul class="navbar-nav nav-flex-icons">
            ...
            <li class="nav-item">
              <a href="logout.php" class="nav-link border border-light rounded waves-effect">
               <i class="far fa-user-circle"></i>Se deconnecter
              </a>
            </li>
          </ul>
...
<hr>
 ...
 <table id="dtable" class = "table table-striped">
    ...
    <th>Telechargement de fichier</th>
     <th>Statut</th>   
     <th>Date/heure</th>
