...
<head>
  ...
  <title>Gestions des mémoires</title>
  <!-- Font Awesome -->
          ...
          <ul class="navbar-nav nav-flex-icons">
            ...
            <li class="nav-item">
              <a href="logout.php" class="nav-link border border-light rounded waves-effect">
               <i class="far fa-user-circle"></i>Déconnexion
              </a>
            </li>
          </ul>
...
<!--end modaladmin-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold"><i class="fas fa-user-plus"></i> Ajouter User </h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body mx-3">
           <div class="md-form mb-5">
          <input type="hidden" id="orangeForm-name" name="status" value = "Etudiant" class="form-control validate" required="">
        </div>
        <div class="md-form mb-5">
          <i class="fas fa-user prefix grey-text"></i>
 ...
 <div class="col-md-12">
  ...
  <table id="dtable" class = "table table-striped" style="">
    ...
    <th>USER connecté</th>    
     ...
     <th>HOST</th>
     <th>ACTION</th> 
     <th>Date_heure Connexion</th>
     <th>ACTION</th> 
     <th>Date_heure Déconnexion</th>
